...
/*Arguments from controlbox:
  ...
  20: 5V meassured too high, 5V, 3V3 or ADC malfunction
  21: 5V meassured too low, 5V, 3V3 or ADC malfunction
  22: Robot current sensor output to high for offset callibration
  23: Robot current sensor output to low for offset callibration
  24: 48V PSU voltage not preset. Check internal connection. (Maybe it does not turn on or maybe it has reverse polarization) 
  25: Robot voltage preset when the 48V PSU is powered up. (Transistors ON/OFF function might be chort circuited)
  26: Voltage present on unpowered 48V PSU
  27: 12V meassured too high, 12V, 3V3 or ADC malfunction
  28: 12V meassured too low, 12V, 3V3 or ADC malfunction
  29: -12V meassured too high, Analog I/O malfunction
  30: -12V meassured too low, Analog I/O malfunction
...
/*        Arguments from controlbox:
         ...
         12:  (OLD) Robot volatage indic. error and not emergency stop indication
         16:  (OLD) Stop indication is low but should be high
         17:  (OLD) safetyErrorIntegratorB>=6000000
         23:  Safety Relay Output Error, malfunction on secondary uP control (minus connction)  (also OLD safety relay error)
         24:  Safety Relay Output Error, malfunction on ColdFire uP control (plus connction)    (also OLD safety relay error)
         ...
         52:  5V meassured to low, 5V, 3V3 or ADC malfunction
         53:  5V meassured to high, 5V, 3V3 or ADC malfunction
         ...
         121: Robot current is too high in sageguard stop state 
...
#define SINGULARITY_DETECTED 174
...
/* Modbus communication erros */
#define MODBUS_ERROR 190

/* these are defined in robotinterface_getandsetmethods.c */
struct s_debug_flags {
  unsigned dump_package_loss;
};
#define DEBUG_FLAG_PACKAGE_LOSS 1
#define USES_DEBUG_FLAGS extern struct s_debug_flags debug_flags
